...
def run_train(level=2,
    ...
    ending = f'lvl{level}--use_rels={use_rels}--use_nucsat={use_nucsat}--use_paths={use_paths}_multi.json'
    ...
    output_dir = f"checkpoint_cls/deberta_glue_binary_noo_lr{lr}-{bs}-{n_epochs}ep_w70_2lin__" + ending.replace('.json', '')
    ...
    subprocess.call(
        ["python",
         "glue_deberta/run_glue_no_trainer.py",
