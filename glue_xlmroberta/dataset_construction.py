...
data_path = 'SemEval-2023-task3-corpus-main/data/ru/'
...
def construct_semeval_dataset(part,
    ...
    with open(f'datasets/discourse_trees/semeval_subtask3_ru_{part}_matched.pkl', 'rb') as f:   
    ...
    df.to_json(f'datasets/deberta_propaganda_classif/{part}_custom_feats={num_feats}_lvl{disco_depth}--use_rels={use_rels}--use_nucsat={use_nucsat}--use_paths={use_paths}_multi_ru.json', orient='records')
